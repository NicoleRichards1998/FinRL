{
  ...
  "metadata": {
    "colab": {
      "name": "DayTradingEnv_Sell_Reward.ipynb",
      "provenance": [],
      "authorship_tag": "ABX9TyPeNl3zviJI9pb/yd8OC/5Z",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/NicoleRichards1998/FinRL/blob/master/DayTradingEnv_Sell_Reward.ipynb\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
